...
_ACTIONS = [
    ...
    _direct("vm.project.update", "VM project変更", "vm", "vm_project_update", "agent.input_models.AgentDomainProjectUpdateInput", risk="R2", requires_generation=True),
    ...
    _direct("storage.pool.delete", "storage pool削除", "storage-pool", "storage_pool_delete", "agent.input_models.StoragePoolDeleteInput", risk="R3", requires_generation=True, destructive=True),
    ...
    _read("project.get", "project詳細", "project", "project_get"),
    _read("project.member-candidates", "project member候補一覧", "project", "project_member_candidates", "agent.input_models.AgentProjectMemberCandidatesInput"),
    _read("project.resource-grant-candidates.get", "project resource grant候補一覧", "project", "project_resource_grant_candidates", "agent.input_models.AgentProjectResourceGrantCandidatesInput"),
    _task("project.create", "project作成", "project", ("post", "project", "root"), "agent.input_models.AgentProjectForCreate"),
    ...
    _direct("project.update", "project名称更新", "project", "project_update", "agent.input_models.AgentProjectUpdateInput", risk="R2", requires_generation=True),
    _direct("project.member.add", "project member追加", "project", "project_member_add", "agent.input_models.AgentProjectMemberInput", risk="R2", requires_generation=True),
    _direct("project.member.remove", "project member削除", "project", "project_member_remove", "agent.input_models.AgentProjectMemberInput", risk="R2", requires_generation=True),
    _direct("project.resource-grants.update", "project resource grant更新", "project", "project_resource_grants_update", "agent.input_models.AgentProjectResourceGrantsUpdateInput", risk="R3", requires_generation=True),
    _read("user.me", "lease principal情報", "user", "user_me"),
    _read("user.list", "利用者一覧", "user", "user_list", "user.schemas.UserForQuery"),
    _direct("user.create", "利用者作成", "user", "user_create", "agent.input_models.AgentUserCreateInput", risk="R3", destructive=True, secret_input=True),
