...
def test_indirect_membership_and_grant_removal_paths_are_guarded(
    ...
    try:
        ...
        assert (
            sole_member_delete.json()["detail"]["code"]
            == "last_project_member_required"
        )
        ...
        assert storage_removal.json()["detail"]["code"] == "storage_pool_in_use"
        ...
        assert (
            storage_pool_delete.json()["detail"]["code"] == "storage_pool_in_use"
        )
        ...
        assert flavor_removal.json()["detail"]["code"] == "flavor_in_use"
