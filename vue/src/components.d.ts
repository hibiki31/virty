...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    NewPasswordFields: typeof import('./components/users/NewPasswordFields.vue')['default']
    ...
    PublicKeyEditor: typeof import('./components/users/PublicKeyEditor.vue')['default']
