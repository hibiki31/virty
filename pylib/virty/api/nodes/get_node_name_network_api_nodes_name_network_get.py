...
from ...models.node_interface import NodeInterface
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = NodeInterface.from_dict(response_200_item_data)
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['NodeInterface']]
    """
