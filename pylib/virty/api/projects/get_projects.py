...
) -> Optional[Union[HTTPValidationError, ProjectPage]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ProjectPage.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ProjectPage]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ProjectPage]
    """
