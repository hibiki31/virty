...
class TestImagePage(unittest.TestCase):
    """ImagePage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImagePage:
        """Test ImagePage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImagePage`
        """
        model = ImagePage()
        if include_optional:
            return ImagePage(
