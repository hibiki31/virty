...
class TestStoragePage(unittest.TestCase):
    """StoragePage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StoragePage:
        """Test StoragePage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StoragePage`
        """
        model = StoragePage()
        if include_optional:
            return StoragePage(
