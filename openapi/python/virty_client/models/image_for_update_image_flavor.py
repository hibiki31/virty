...
class ImageForUpdateImageFlavor(BaseModel):
    """
    ImageForUpdateImageFlavor
    """ # noqa: E501
    storage_uuid: StrictStr = Field(alias="storageUuid")
    path: StrictStr
    node_name: StrictStr = Field(alias="nodeName")
    flavor_id: StrictInt = Field(alias="flavorId")
    __properties: ClassVar[List[str]] = ["storageUuid", "path", "nodeName", "flavorId"]
