...
class Domain(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "core", "memory", "status", "description", "nodeName", "ownerUserId", "ownerProjectId", "ownerProject", "vncPort", "vncPassword", "drives", "interfaces"]
