...
class UserPage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["username", "scopes", "projects"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "projects": [UserProject.from_dict(_item) for _item in obj.get("projects")] if obj.get("projects") is not None else None
        })
        return _obj
