...
class StoragePool(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "storages"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "storages": [StorageContainerForStoragePool.from_dict(_item) for _item in obj.get("storages")] if obj.get("storages") is not None else None
        })
        return _obj
