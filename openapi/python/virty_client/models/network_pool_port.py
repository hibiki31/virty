...
class NetworkPoolPort(BaseModel):
    """
    NetworkPoolPort
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "vlanId", "network"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "network": NetworkForNetworkPool.from_dict(obj.get("network")) if obj.get("network") is not None else None
        })
        return _obj
