...
class NodeRoleForUpdate(BaseModel):
    """
    NodeRoleForUpdate
    """ # noqa: E501
    node_name: StrictStr = Field(alias="nodeName")
    role_name: StrictStr = Field(alias="roleName")
    extra_json: Optional[Dict[str, Any]] = Field(default=None, alias="extraJson")
    __properties: ClassVar[List[str]] = ["nodeName", "roleName", "extraJson"]
